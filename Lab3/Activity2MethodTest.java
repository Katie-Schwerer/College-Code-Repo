...
/**
 * The test class Activity2MethodTest.
 *
...
public class Activity2MethodTest
{
    ...
    private static final String CHECKER_XML = 
        ...
        + "cs_appstate2.xml";
    private static final String FILE_TO_TEST = "Activity2PayStub.java";
    ...
    private Activity2PayStub paystub;
    ...
    {
        int total = prelabGrade + activity1Grade + activity2Grade;
